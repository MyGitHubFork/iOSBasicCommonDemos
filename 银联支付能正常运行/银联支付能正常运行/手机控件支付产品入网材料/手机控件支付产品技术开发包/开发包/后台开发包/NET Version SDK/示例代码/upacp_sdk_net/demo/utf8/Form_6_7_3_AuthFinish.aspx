<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Form_6_7_3_AuthFinish.aspx.cs" Inherits="Form_6_7_3_AuthFinish" %>
...
<%
    ...
    param["origQryId"] = "201502281208545526848";//原预授权的queryId，可以从查询接口或者通知接口中获取
    param["txnTime"] = DateTime.Now.ToString("yyyyMMddHHmmss");//订单发送时间，重新产生，不同于原消费
    param["txnAmt"] = "1";//交易金额，小于等于原预授权金额的115%
