...
- (id)init {
	self = [super init];
	if(self != nil) {
		self.deviceToken = @"76c0e619 a98b6e6d b34de7e6 7f24480c 105a376c 67dbabf1 f696758f a248c383";
		//self.payload = @"{\"aps\":{\"alert\":\"dfdd\",\"badge\":1}}";
        self.payload = @"{\"aps\":{\"alert\":\"黄成都你好\",\"badge\":6,\"sound\":\"布谷鸟.caf\",\"newID\":\"4987\", \"other\":\"钓鱼岛是我们中国的\",}}";
